...
let handler = async (m, { conn, text }) => {
  ...
  try {
    let res = await fetch(`https://api.akuari.my.id/textpro/scraper-2?text=${encodeURIComponent(text1)}&text2=${encodeURIComponent(text2)}&link=https://textpro.me/text-logo-3d-metal-galaxy-943.html`);
