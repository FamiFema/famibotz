...
handler.all = async function (m) {
	...
	try {
		...
		global.kontak2 = [
         [owner[0], await conn.getName(owner[0] + '6283843362676@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'dedsec.ext4@gmail.com', true], // Kalo mau di tambah tinggal copy 1baris ini di tempel di bawahnya trs di edit dikit!
        ]
        ...
        global.fvn = {
            ...
            { remoteJid: "6283843362676-1625305606@g.us" } : {}) 
                       },
            message: { 
               "audioMessage": {
